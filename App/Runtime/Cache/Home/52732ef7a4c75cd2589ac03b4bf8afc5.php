...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="/ThinkPHP/Public/js/html5shiv.js"></script>
      <script src="/ThinkPHP/Public/js/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
    <div class="container">
      ...
      <div class="demo-row typography-row">
      	...
      	<div class="demo-content">      		
	          ...
	          <img src="/ThinkPHP/Public/images/exaple-image.jpg" alt="exaple-image" class="img-rounded img-responsive">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="/ThinkPHP/Public/images/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>          
          <div><img src="/ThinkPHP/Public/images/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/map.svg" alt="Map"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/book.svg" alt="Book"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="/ThinkPHP/Public/images/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-samples">
        ...
        <div class="col-xs-8 demo-video">
          <!--[if !IE]> -->
            <video class="video-js" controls preload="auto" width="620" height="349" poster="/ThinkPHP/Public/images/video/poster.jpg" data-setup="{}">
      ...
      <div class="row demo-tiles">
        <div class="col-xs-3">
          <div class="tile">
            <img src="/ThinkPHP/Public/images/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="/ThinkPHP/Public/images/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="/ThinkPHP/Public/images/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile tile-hot">
            <img src="/ThinkPHP/Public/images/icons/svg/chat.svg" alt="Chat" class="tile-image">
      ...
      <div class="row">
        <div class="col-xs-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="/ThinkPHP/Public/images/demo/browser-pic-1.jpg" alt="" />
              <img src="/ThinkPHP/Public/images/demo/browser-pic-2.jpg" alt="" />
              <img src="/ThinkPHP/Public/images/demo/browser-pic-3.jpg" alt="" />
              <img src="/ThinkPHP/Public/images/demo/browser-pic-4.jpg" alt="" />
              <img src="/ThinkPHP/Public/images/demo/browser-pic-5.jpg" alt="" />
              <img src="/ThinkPHP/Public/images/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-3">
          <div class="demo-download">
            <img src="/ThinkPHP/Public/images/demo/html-icon.png" src="Free PSD" />
          </div>
        ...
        <div class="row">
          <div class="col-xs-7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="/ThinkPHP/Public/images/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /col-xs-7 -->
    ...
    <script src="/ThinkPHP/Public/js/jquery-1.8.3.min.js"></script>
    <script src="/ThinkPHP/Public/js/jquery-ui-1.10.3.custom.min.js"></script>
    <script src="/ThinkPHP/Public/js/jquery.ui.touch-punch.min.js"></script>
    <script src="/ThinkPHP/Public/js/bootstrap.min.js"></script>
    <script src="/ThinkPHP/Public/js/bootstrap-select.js"></script>
    <script src="/ThinkPHP/Public/js/bootstrap-switch.js"></script>
    <script src="/ThinkPHP/Public/js/flatui-checkbox.js"></script>
    <script src="/ThinkPHP/Public/js/flatui-radio.js"></script>
    <script src="/ThinkPHP/Public/js/jquery.tagsinput.js"></script>
    <script src="/ThinkPHP/Public/js/jquery.placeholder.js"></script>
    <script src="/ThinkPHP/Public/js/jquery.stacktable.js"></script>
    <script src="/ThinkPHP/Public/js/video.js"></script>
    <script src="/ThinkPHP/Public/js/application.js"></script>
  </body>
</html>